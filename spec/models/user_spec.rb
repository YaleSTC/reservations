...
describe User do
  ...
  describe ".is_admin_in_checkoutpersonmode?" do
    ...
    it "should return false if user is admin in adminmode" do
      admin_as_admin = FactoryGirl.create(:admin, view_mode: 'admin')
