...
describe AppConfigsController do
  ...
  context 'User is admin' do
    ...
    describe 'GET edit' do
      ...
      describe 'There is some existing AppConfig' do
      ...
      describe 'There is no existing AppConfig' do
        it 'assigns default configuration to @app_config' do
          assigns(:app_config).should be_new_record
          assigns(:app_config).kind_of?(AppConfig).should be_true
        end
      end
