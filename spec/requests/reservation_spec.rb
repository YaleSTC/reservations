...
#    res.save.should == false
  ...
  it 'passes/fails quantity_eq_model_allowed? correctly' do
    ...
    max_res = FactoryGirl.create(:reservation, reserver: admin, equipment_model: max_mod)
...
#    max_res2.save.should == false
    ...
    unrestricted_res = FactoryGirl.create(:reservation, reserver: admin, equipment_model: unrestricted_mod)
