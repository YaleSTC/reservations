class Requirement < ActiveRecord::Base
  ...
  has_and_belongs_to_many :users,
   ...
   attr_accessible :user_id, :description, :equipment_model_id, :equipment_model, :contact_info, :contact_name, :requirement_ids, :user_ids, :equipment_model_ids, :equipment_models
