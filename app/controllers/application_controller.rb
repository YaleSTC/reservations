...
class ApplicationController < ActionController::Base
  ...
  def deactivate
    ...
    flash[:notice] = "Successfully deactivated " + params[:controller].singularize.titleize + ". Any related equipment has been deactivated as well. Any related reservations have been permanently deleted."
